...
export const quizQuestions: QuizQuestion[] = [
  ...
  },
  {
    ...
    options: [
      ...
      {
        text: 'Mollis pretium lorem primis senectus habitasse lectus integer.',
        traits: ['Malandrino', 'Cleptomane'],
        aspiration: 'Nemico Pubblico'
      },
      {
        text: 'Porta class feugiat nam mus senectus curabitur elementum cubilia.',
  ...
  },
  {
    ...
    options: [
      {
        text: 'Velit esse cillum dolore eu fugiat nulla pariatur excepteur sint.',
        traits: ['Incline ai bambini', 'Buono'],
        aspiration: 'Grande Famiglia'
      },
      {
        text: 'Occaecat cupidatat non proident, sunt in culpa qui officia.',
        traits: ['Ambizioso', 'Snob'],
        aspiration: 'Incredibilmente Ricco'
      },
      {
        text: 'Deserunt mollit anim id est laborum et dolorum fuga harum.',
        traits: ['Avventuroso', 'Amante dell\'aria aperta'],
        aspiration: 'Esploratore delle Giungle'
      },
      {
        text: 'Liber tempor cum soluta nobis eleifend option congue nihil.',
  ...
  },
  {
    ...
    options: [
      {
        text: 'Aenean sollicitudin, arcu a laoreet tempor, risus neque pretium.',
        traits: ['Genio', 'Attivo'],
        aspiration: 'Cervello Straordinario'
      },
      {
        text: 'Class aptent taciti sociosqu ad litora torquent per conubia.',
        traits: ['Snob', 'Materialista'],
        aspiration: 'Incredibilmente Ricco'
      },
      {
        text: 'Quisque cursus, metus vitae pharetra auctor, sem massa mattis.',
        traits: ['Irascibile', 'Malandrino'],
        aspiration: 'Nemico Pubblico'
      },
      {
        text: 'Donec laoreet nonummy augue. Suspendisse dui purus, scelerisque.',
...
export const traitDescriptions: Record<string, string> = {
  'Genio': 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis sed dapibus leo, nec finibus mi.',
  'Solitario': 'Aenean lobortis diam at interdum eleifend. Ut gravida rhoncus dolor, ac convallis enim.',
  'Estroverso': 'Praesent at nunc a lectus eleifend elementum sit amet tristique mi. Sed vitae interdum.',
  'Incline ai party': 'Vivamus vestibulum ligula sed nulla pharetra, vitae facilisis ex volutpat. Quisque.',
  'Creativo': 'Nam eleifend hendrerit massa, vitae congue tortor feugiat sed. Aliquam erat volutpat.',
  'Amante dell\'arte': 'Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat.',
  'Attivo': 'Mauris dictum tincidunt nisl, nec maximus libero consequat quis. Aliquam interdum urna.',
  'Amante dell\'aria aperta': 'Nullam hendrerit mi eu finibus feugiat. Vestibulum pretium scelerisque elit, id.',
  'Buono': 'Quisque sodales scelerisque turpis, id condimentum dolor imperdiet vitae. Duis feugiat, elit.',
  'Ordinato': 'Sed rhoncus lectus magna, quis facilisis leo tincidunt vitae. Nunc at pretium ante. Etiam.',
  'Malandrino': 'Curabitur pretium tincidunt lacus. Nulla gravida orci a odio. Nullam varius, turpis et.',
  'Cleptomane': 'Aliquam sollicitudin, arcu a laoreet tempor, risus neque pretium ipsum, sed convallis.',
  'Ambizioso': 'Morbi leo mi, nonummy eget, tristique non, rhoncus non, leo. Nullam tempor. Class aptent.',
  'Materialista': 'Quisque cursus, metus vitae pharetra auctor, sem massa mattis sem, at interdum magna.',
  'Incline ai bambini': 'Aenean nec lorem. In porttitor. Donec laoreet nonummy augue. Suspendisse dui purus.',
  'Snob': 'Consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et.',
  'Avventuroso': 'Ut enim ad minima veniam, quis nostrum exercitationem ullam corporis suscipit laboriosam.',
  'Perfezionista': 'Quis autem vel eum iure reprehenderit qui in ea voluptate velit esse quam nihil.',
  'Irascibile': 'At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium.',
  'Buffo': 'Et harum quidem rerum facilis est et expedita distinctio. Nam libero tempore, cum soluta.'
};

export const aspirationDescriptions: Record<string, string> = {
  'Cervello Straordinario': 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis sed dapibus leo, nec finibus mi.',
  'Sim socievole': 'Aenean lobortis diam at interdum eleifend. Ut gravida rhoncus dolor, ac convallis enim.',
  'Genio Creativo': 'Praesent at nunc a lectus eleifend elementum sit amet tristique mi. Sed vitae interdum.',
  'Atleta Professionista': 'Vivamus vestibulum ligula sed nulla pharetra, vitae facilisis ex volutpat. Quisque.',
  'Grande Famiglia': 'Nam eleifend hendrerit massa, vitae congue tortor feugiat sed. Aliquam erat volutpat.',
  'Incredibilmente Ricco': 'Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat.',
  'Nemico Pubblico': 'Mauris dictum tincidunt nisl, nec maximus libero consequat quis. Aliquam interdum urna.',
  'Esploratore delle Giungle': 'Nullam hendrerit mi eu finibus feugiat. Vestibulum pretium scelerisque elit, id.'
};
